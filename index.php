...
<head>
  ...
  <link href="libs/css/materialize/css/materialize.css" type="text/css" rel="stylesheet" media="screen,projection"/>
  <link href="libs/css/materialize/css/style.css" type="text/css" rel="stylesheet" media="screen,projection"/>
</head>
<body>
  <nav class="light-blue lighten-1" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo">Logo</a>
      <ul class="right hide-on-med-and-down">
        <li><a href="controllerproducto/index.php">Productos</a></li>
        <li><a href="controllertienda/index.php">Tienda</a></li>
        <li><a href="controllerdepto/index.php">Departamento</a></li>
  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      <br><br>
      <h1 class="header center orange-text">Tienda Proyecto WalK-MART</h1>
      <div class="row center">
        <h5 class="header col s12 light">Desarrollo de proyecto de la materia de base de datos</h5>
      </div>
      <div class="row center">
        <a href="/ventamati/controllerproducto/index.php" id="download-button" class="btn-large waves-effect waves-light orange">Registro Producto</a>
      </div>
      <br><br>
  ...
  <script src="libs/css/materialize/js/materialize.js"></script>
  <script src="libs/css/materialize/js/init.js"></script>
