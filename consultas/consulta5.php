...
<head>
    ...
    <title>20 productos de los que menos se tiene en el inventario </title>
...
<div class="container" ng-app="myApp" ng-controller="productsCtrl">
    <div class="row">
        <div class="col s12">
            <h4>20 productos de los que menos se tiene en el inventario </h4>
...
<table class="hoverable bordered">
    ...
    <thead>
        <tr>
            ...
            <th class="width-30-pct">Descripcion Venta</th>
            <th class="width-30-pct">Cantidad</th>
            <th class="width-30-pct">U. Medida</th>
